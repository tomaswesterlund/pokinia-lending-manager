...
import 'package:pokinia_lending_manager/pages/loans/new/select_loan_type_page.dart';
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          if (loan.type == LoanTypes.zeroInterestLoan) {
                            ...
                            return ZeroInterestLoanListCard(client: client, loan: loan, zeroInterestLoan: zeroInterestLoan);
                          } else {
