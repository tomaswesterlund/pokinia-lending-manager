...
class _NewZerointerestLoanPageState extends State<NewZerointerestLoanPage> {
  ...
  void _createLoan(BuildContext context, LoanProvider loanService) async {
    if (_formKey.currentState!.validate()) {
      setIsProcessing(true);

      var zeroInterestLoanService = Provider.of<ZeroInterestLoanProvider>(context, listen: false);
