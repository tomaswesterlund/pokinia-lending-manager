...
import 'package:pokinia_lending_manager/components/universal/texts/amounts/small_amount_text.dart';
...
class OpenEndedDefaultListCard extends StatelessWidget {
  final LoanStatementEntity loanStatement;
  const OpenEndedDefaultListCard({super.key, required this.loanStatement});
